...
$('a.show-modal').live('click', function() {
	$('div.custom-modal').fadeIn();
	return false;
});

// close modal
$('.close-modal').live('click', function() {
	$('div.custom-modal').fadeOut();
	$('div.custom-modal div.modal-container div.modal-content').html('');
...
function modalContent(html) {
	$('div.custom-modal div.modal-container div.modal-content').html(html);
